...
return new class extends Migration
{
    ...
    {
        DB::statement("UPDATE attachments SET category = 'other' WHERE category = 'checkout_selfie'");
        DB::statement("ALTER TABLE attachments MODIFY category ENUM(
            'payment_proof','task_before','task_after','bast_document','survey_report',
            'quotation_signed','purchase_order','pph23_slip','checkin_selfie','sow_background','other'
        ) NOT NULL");
    }
};
