    ...
    return (
        <AppLayout>
            ...
            <div className="mx-auto max-w-4xl space-y-5">
                <PageHeader title="Scope of Work" subtitle="SOW untuk project yang dikerjakan tim Anda — tanda tangani sebagai PIC Vendor." />
                <DataTable
                    columns={columns}
                    rows={sows.data}
                    rowKey="id"
                    rowHref={(s) => `/vendor/sows/${s.id}`}
                    empty={<EmptyState title="Belum ada SOW." />}
